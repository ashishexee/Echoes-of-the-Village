# Echoes of the Village (OpenChain Blockchain Edition)
...
* **Blockchain**: OpenChain Network - A next-generation Layer 1 blockchain with high throughput and low latency.
